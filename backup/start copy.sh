...
kubectl create cm ${CHANNEL_NAME}-anchorpeer-org2 --from-file=Org2MSPanchors.tx=${GENERATED_FOLDER}/configtx/Org2MSPanchors.tx -n dscf
...
kubectl exec utility-pod -n dscf -- sh -c 'CORE_PEER_LOCALMSPID=Org2MSP CORE_PEER_MSPCONFIGPATH=/crypto/org2/users/Admin@org2/msp CORE_PEER_TLS_ROOTCERT_FILE=/crypto/org2/peers/org2-peer1/tls/ca.crt CORE_PEER_ADDRESS=org2-peer1:7051 peer channel join -b ${CHANNEL_NAME}_config.block'
